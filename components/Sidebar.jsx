...
export default function Sidebar({ activeView, setActiveView, pendingCount = 0 }) {
  ...
  return (
    <div className="w-64 bg-white border-r min-h-screen p-4">
      <div className="mb-8">
        <h2 className="text-xl font-bold text-gray-900">Corretor 80/20</h2>
        <p className="text-xs text-gray-500">Plataforma de Correção IA</p>
      </div>
              ...
              <>
                <Button
                  ...
                  className={cn(
                    ...
                    (activeView === 'pendentes' || activeView === 'concluidas') && 'bg-blue-50 text-blue-700'
                  )}
                    ...
                    {item.children?.map((child) => (
                      <Button
                        ...
                        className={cn(
                          ...
                          activeView === child.id && 'bg-blue-50 text-blue-700'
                        )}
